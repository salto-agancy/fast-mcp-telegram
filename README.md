...
| :label: **[Multi-Account Tool Prefix](docs/Installation.md#multi-account-mcp-tool-prefix)**          | Optional `PREFIX_MCP_TOOLS_WITH_ACCOUNT` — prefixes tool names per session (username or user ID) for multi-account agents on one server |
